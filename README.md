...
##### <a name="Step2"></a>	ШАГ 2, СОЗДАЕМ И ВЫПОЛНЯЕМ задачу
...
##### <a name="Step3"></a>  ПЕРЕНОСИМ ИЗМЕНЕНИЯ _(задачи в ветку копии)_
...
##### <a name="Step4"></a>	ШАГ 4, ВНЕДРЕНИЕ _(ветки копия в ветку master)_
...
##### <a name="Step4_1"></a>	**СЛИЯНИЕ ВЕТОК** master и copy_xxxxxxxx_xx
...
7. Удаляем вспомогательную ветку созданную для актуализации данных:   **git branch -d** copy_xxxxxxxx_xx
