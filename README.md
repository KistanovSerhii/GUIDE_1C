...
1. _Иначе ветку копии необходимо СОЗДАТЬ и ВЫБРАТЬ ее_ 🔎 **git checkout -b** copy_xxxxxxxx_xx     

+ СОЗДАНИЕ задачи:

2. Создаем для задачи ветку _в ветке copy_xxxxxxxx_xx_ 🐤 **git branch**   ITTF_01
3. Переходим на ветку задачи:                              **git checkout** ITTF_01
4. Проверяем переход:                                      **git branch**

##### <a name="Step2_3"></a>
+ РАБОТА НАД ЗАДАЧЕЙ:

5. Открываем конфигурацию "Х" (или открыл обк "Х") _(в РЕЗЕРВНОЙ копии)_
6. Вносим изменения 🛠️
