...
# ШАГ 2, ПЕРЕД ВНЕСЕНИЕМ ЛЮБЫХ ИЗМЕНЕНИЙ
##### <a name="Step2"></a>	ШАГ 2, ПЕРЕД ВНЕСЕНИЕМ ЛЮБЫХ ИЗМЕНЕНИЙ _(актуализируем данные)_
...
#
    git add .
    git commit -m "update_20220304_01"
    git push -u origin update_20220304_01
...
#
    git merge** update_20220304_01
    git commit -m "merge update_20220304_01"
    git push -u origin main 
   _// где "update_20220304_01" - это название ветки-источник_
   _// где main - это имя первичной ветки._
...
# Выгрузить ветку
11. Когда захотим выгрузить ветку на удаленный сервер:   **git push -u origin** _ITTF_01_

# КОГДА ЗАДАЧА ГОТОВА
12. КОГДА ЗАДАЧА БУДЕТ ГОТОВА - выполняем ШАГ №2, после чего   ##### <a name="Step2_1"></a>   "СЛИЯНИЕ ВЕТОК" **main с ITTF_01**
