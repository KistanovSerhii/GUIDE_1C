...
+ [ШАГ 1, Начало работы КОГДА РЕПОЗИТОРИЙ (проект) СУЩЕСТВУЕТ на этом ПК](#step11);  🟣
+ [ШАГ 1, Начало работы КОГДА РЕПОЗИТОРИЙ (проект) ОТСУТСТВУЕТ на этом ПК](#step12); 🔘
...
##### <a name="step11"></a> ШАГ 1 [(начало)](#pageup);
...
##### <a name="step12"></a> ШАГ 1 [(начало)](#pageup);
