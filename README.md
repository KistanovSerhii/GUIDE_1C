...
+ [ШАГ 4, ВНЕДРЕНИЕ (ветки копия в ветку master)](#Step4);      🛰️
+ [СЛИЯНИЕ ВЕТОК](#Step4_1); ⚛️
...
# ШАГ 4, ВНЕДРЕНИЕ _(ветки копия в ветку master)_ 🛰️
...
5. Удаляем вспомогательную ветку созданную для актуализации данных: ✖
